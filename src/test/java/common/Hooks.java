...
//	public static File lastModified;
	...
	private Map<String, String> testCaseData = new HashMap<>();
	public static File lastModified;
	...
	public static HashMap<String, String> scenarioTags = new HashMap<>();
	...
	public void init(Scenario scenario) {
        ...
        // Store tags dynamically in the map
        scenarioTags.put(scenarioName, tags);
        testCaseData.put("name", scenario.getName());
	...
	public void closeBrowser(Scenario scenario) {
		...
		testCaseData.put("",scenario.getStatus().toString());
		testResults.add(testCaseData);
		System.out.println("------------------------------");
		...
		lastModified = Arrays.stream(files).filter(File::isDirectory).max(Comparator.comparing(File::lastModified))
				.orElse(null);
